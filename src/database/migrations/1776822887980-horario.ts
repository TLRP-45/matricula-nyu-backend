...
export class Horario1776822887980 implements MigrationInterface {
    name = 'Horario1776822887980'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`Horario\` (\`ID_oferta\` int NOT NULL, \`ID_horario\` int NOT NULL AUTO_INCREMENT, \`lugar\` varchar(100) NOT NULL, \`hora\` date NOT NULL, \`ofertaIDOferta\` int NULL, PRIMARY KEY (\`ID_oferta\`, \`ID_horario\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`Horario\` ADD CONSTRAINT \`FK_d3b90e4660c4bff8e55cf51da1f\` FOREIGN KEY (\`ofertaIDOferta\`) REFERENCES \`OfertasAcademicas\`(\`ID_oferta\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Horario\` DROP FOREIGN KEY \`FK_d3b90e4660c4bff8e55cf51da1f\``);
